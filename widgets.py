...
class HelpDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.text_browser.setHtml("""
            ...
            <ul>
                <li><b>Load Video</b>: Начинает новый проект с одним файлом.</li>
            ...
            <ul>
                <li>Используйте слайдер и кнопки "Set Start" / "Set End", чтобы выбрать фрагмент.</li>
                <li><b>Apply Cut (Remove Selection)</b>: Удаляет выбранный участок из таймлайна.</li>
                ...
                <li>Чтобы начать заново, используйте "Clear Timeline" или "Load Video".</li>
            </ul>
            ...
            <ul>
                ...
                <li>Внешний звук будет обрезан или зациклен под длину видео (зависит от длины).</li>
            </ul>
